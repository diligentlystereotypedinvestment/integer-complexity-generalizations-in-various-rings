...
public class GaussExpression{
    ...
    public GaussExpression(Gauss G, ArrayList<Integer> E)
    {
        g = G;
        e = E;
    }

    public GaussExpression(GaussExpression a, GaussExpression b, int n) //concatonates two GaussExpressions
    {
        /* Rules:
        ...
        if (n == 1)
            g = Gauss.add(a.getG(), b.getG());
        if (n == -1)
            g = Gauss.multiply(a.getG(), b.getG());
